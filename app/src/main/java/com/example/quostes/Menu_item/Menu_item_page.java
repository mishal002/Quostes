...
public class Menu_item_page extends AppCompatActivity {

    TextView text_txt;
    ImageView back, Shayri1;
    List<Menu_modal_class>l1 = new ArrayList<>();

    RecyclerView recycle;

    int Image[] = {R.drawable.img11, R.drawable.img11, R.drawable.img11, R.drawable.img11, R.drawable.img11, R.drawable.img11, R.drawable.img11};
...
//    private TextToSpeech textToSpeech;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_txt.setText(name);


        for (int i = 0; i < name.length(); i++) {

            Menu_modal_class m1 = new Menu_modal_class(name[i]);
            l1.add(m1);
        }

        Menu_Adepter menu_adepter = new Menu_Adepter(Menu_item_page.this,l1);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Menu_item_page.this);
        recycle.setLayoutManager(layoutManager);
        recycle.setAdapter(menu_adepter);
    ...
    public void biding() {
        text_txt = findViewById(R.id.text_txt);
        back = findViewById(R.id.back);
        Shayri1 = findViewById(R.id.shayri1);
    ...
    void Add_set_metod() {
        ...
        if (title.equals(name[0])) {
            ...
            for (int i = 0; i < love.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(love[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
            ...
            for (int i = 0; i < Friend.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(Friend[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
            ...
            for (int i = 0; i < birthday.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(birthday[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
...
//                    "“Style is a reflection of your attitude and your personality.”",
            ...
            for (int i = 0; i < acititude.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(acititude[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
...
//                    "“I would rather be alone and a loud voice for action than be silent.\n”",
            ...
            for (int i = 0; i < alone.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(alone[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
...
//                    "“Success is the ability to go from failure to failure without losing your enthusiasm.”",
            ...
            for (int i = 0; i < failure.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(failure[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
...
//                    "“The dice of God are always loaded.”",
            ...
            for (int i = 0; i < god.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(god[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
...
//                    "“The greatest power is not money power, but political power.”",
            ...
            for (int i = 0; i < power.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(power[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
...
//                    "“He who has been bitten by a snake fears a piece of string.”",
            ...
            for (int i = 0; i < experience.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(experience[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
...
//                    "“Leadership demands that we make tough choices.”",
            ...
            for (int i = 0; i < leadership.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(leadership[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
...
//                    "“I am dying with the help of too many physicians.”",
            ...
            for (int i = 0; i < science.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(science[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
...
//                    "“A lifetime of training for just ten seconds.”",
            ...
            for (int i = 0; i < sport.length; i++) {
                Menu_modal_class model_class = new Menu_modal_class(sport[i], swicth_img[i]);
                l1.add(model_class);
                Menu_Adepter adpter = new Menu_Adepter(Menu_item_page.this, l1);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
                rv_sayri.setLayoutManager(layoutManager);
